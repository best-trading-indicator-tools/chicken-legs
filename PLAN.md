...
- Added the user's [original tweet](https://x.com/david_attisaas/status/2099147589551788373) below the collage as a compact dark X embed, with a direct link to the replies. The source text and link remain available if the embed cannot load.
