...
| Music | Use `assets/private/music/chicken-musicV2.mp3` for an optional looping soundtrack. A music icon in the website header starts off and only downloads/plays the track after a visitor turns it on. Keep the source private and publish a metadata-free audio derivative. |
